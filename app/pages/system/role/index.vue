<template>
  ...
  import { GetRolePage, DeleteRole, ExportRole, type RoleVO } from '@/api/system/role'
  import RoleForm from './_plugs/RoleForm.vue'
  import RoleAssignMenuForm from './_plugs/RoleAssignMenuForm.vue'
  import RoleDataPermissionForm from './_plugs/RoleDataPermissionForm.vue'
  ...
  const openDataPermissionForm = async (row: RoleVO) => {
    dataPermissionFormRef.value.open(row)
  }
  
  /** 菜单权限操作 */
  const assignMenuFormRef = ref()
  const openAssignMenuForm = async (row: RoleVO) => {
  ...
  const handleExport = async () => {
    try {
      ...
      const data = await ExportRole(queryParams)
